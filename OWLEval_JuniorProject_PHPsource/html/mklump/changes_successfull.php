<?php 
  ...
  function DrawPage()
  {
	...
	<FORM action="http://matthew.klump-pdx.com/blues/glenn/eval_aug.php" method="post">
	...
	<FORM action="http://matthew.klump-pdx.com/blues/gwr/admin_menu.php" method="post">
	<input type=hidden name=fac_name value="<?php echo $_POST['fac_name']; ?>"></input>
