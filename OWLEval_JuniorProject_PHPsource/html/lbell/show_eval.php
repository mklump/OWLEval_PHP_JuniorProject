    ...
    { 
      ...
      while ($row=mysql_fetch_array($result))
      {
        if($row[2]== 1)
        {
          ...
          echo "<td width=125 valign=top><center><input type=radio name=question_$cntr value=\"Strongly Agree\"><br>Excellent</td>\n";
          echo "<td width=125 valign=top><center><input type=radio name=question_$cntr value=\"Agree\"><br>Good</td>\n";
          echo "<td width=125 valign=top><center><input type=radio name=question_$cntr value=\"Neutral\"><br>Satifactory</td>\n";
          echo "<td width=125 valign=top><center><input type=radio name=question_$cntr value=\"Disagree\"><br>Acceptable</td>\n";
          echo "<td width=125 valign=top><center><input type=radio name=question_$cntr value=\"Strongly Disagree\"><br>Poor</td>\n";
